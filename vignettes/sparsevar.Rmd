---
title: "sparsevar package"
author: "Lorenzo Frattarolo and Simone Vazzoler"
date: "`r Sys.Date()`"
output: 
...
estimated using cross-validation. When using `ENET` it is possible to estimate VAR(1) of dimension 
...
The authors of `sparsevar` are Lorenzo Frattarolo and Simone Vazzoler and the R package is mantained by Simone Vazzoler. This vignette describes the usage of `sparsevar` in R.
